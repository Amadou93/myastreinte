...
import { BasededonneeComponent } from 'app/entities/basededonnee/basededonnee.component';
...
describe('Component Tests', () => {
  describe('Basededonnee Management Component', () => {
    let comp: BasededonneeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BasededonneeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.basededonnees[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
