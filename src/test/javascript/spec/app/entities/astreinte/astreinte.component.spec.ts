...
import { AstreinteComponent } from 'app/entities/astreinte/astreinte.component';
...
describe('Component Tests', () => {
  describe('Astreinte Management Component', () => {
    let comp: AstreinteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AstreinteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.astreintes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
