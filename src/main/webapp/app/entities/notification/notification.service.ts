...
export class NotificationService {
  ...
  protected convertDateFromClient(notification: INotification): INotification {
    const copy: INotification = Object.assign({}, notification, {
      ...
      availiblity: notification.availiblity != null && notification.availiblity.isValid() ? notification.availiblity.toJSON() : null
    });
    return copy;
  }
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      ...
      res.body.availiblity = res.body.availiblity != null ? moment(res.body.availiblity) : null;
    }
    return res;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((notification: INotification) => {
        ...
        notification.availiblity = notification.availiblity != null ? moment(notification.availiblity) : null;
      });
    }
    return res;
  }
