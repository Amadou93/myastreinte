...
/**
 * REST controller for managing {@link sn.free.myastreinte.domain.Departement}.
 */
@RestController
@RequestMapping("/api")
public class DepartementResource {
    ...
    public ResponseEntity<List<DepartementDTO>> getAllDepartements(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
