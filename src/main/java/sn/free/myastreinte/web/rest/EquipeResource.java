...
/**
 * REST controller for managing {@link sn.free.myastreinte.domain.Equipe}.
 */
@RestController
@RequestMapping("/api")
public class EquipeResource {
     ...
     */
    @GetMapping("/equipes")
    public ResponseEntity<List<EquipeDTO>> getAllEquipes(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
