...
/**
 * REST controller for managing {@link sn.free.myastreinte.domain.Notification}.
 */
@RestController
@RequestMapping("/api")
public class NotificationResource {
    ...
    public ResponseEntity<List<NotificationDTO>> getAllNotifications(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
